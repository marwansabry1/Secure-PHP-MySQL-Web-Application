...
<head>
  ...
  <title>MKR Motors – Pre-Owned Cars</title>
...
<body>
  ...
  <div class="hero hero-banner">
    <div class="hero-content">
      ...
      <p>Discover reliable pre-owned vehicles inspected for quality, comfort, and value.</p>
    </div>
  </div>
  ...
  <main class="container-list">
    ...
    <aside class="sidebar">
      ...
      <form method="GET" action="preowned-cars.php" class="filter-form">
        ...
        <button class="apply-btn">Apply Filter</button><br><br>
        <a href="preowned-cars.php" class="reset-btn">Reset</a>
      </form>
    </aside>
    ...
    <section class="car-list">
      ...
      <?php
        ...
        $sql = "SELECT * FROM cars WHERE status = 'pre-owned'";
        $types = "";
        $params = array();
        ...
        if ($stmt) {
          ...
          if ($result && $result->num_rows > 0) {
            ...
            echo "<p>No pre-owned cars match your filters. Try adjusting your search.</p>";
          }
          $stmt->close();
        } else {
